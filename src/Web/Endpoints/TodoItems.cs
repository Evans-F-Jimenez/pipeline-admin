using pipeline.Application.Common.Models;
using pipeline.Application.TodoItems.Commands.CreateTodoItem;
using pipeline.Application.TodoItems.Commands.DeleteTodoItem;
using pipeline.Application.TodoItems.Commands.UpdateTodoItem;
using pipeline.Application.TodoItems.Commands.UpdateTodoItemDetail;
using pipeline.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace pipeline.Web.Endpoints;
